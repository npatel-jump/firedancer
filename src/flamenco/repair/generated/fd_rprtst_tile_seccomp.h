...
#ifndef HEADER_fd_______src_flamenco_repair_generated_fd_rprtst_tile_seccomp_h
#define HEADER_fd_______src_flamenco_repair_generated_fd_rprtst_tile_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_fd_rprtst_tile_instr_cnt = 14;

static void populate_sock_filter_policy_fd_rprtst_tile( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 14 );

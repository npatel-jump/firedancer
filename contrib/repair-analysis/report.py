...
def repair_efficiency_heatmap(repair_requests, shreds_data, snapshot_slot, first_turbine, pdf):
    ...
    # Clip efficiency ratios to minimum of 0 (anything below 0 becomes 0)
    efficiency_data['efficiency_ratio'] = np.maximum(0, efficiency_data['efficiency_ratio'])
    ...
    im = ax.imshow(heatmap_matrix, cmap='RdYlGn_r', aspect='auto', interpolation='nearest',
                   vmin=0, vmax=max_efficiency_ratio)
